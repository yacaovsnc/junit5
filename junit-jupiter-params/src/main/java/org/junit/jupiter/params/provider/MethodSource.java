 ...
 * {@link Arguments}, an array of reference types (e.g., {@code Object[]},
 * {@code String[]}, etc.), or a single <em>value</em> if the parameterized test
 * method accepts a single argument.
 *
 * <p>Please note that an array of reference types supplied as a set of "arguments"
 * will be handled differently than other types of arguments. Specifically, all of
 * the elements of such an array will be passed as individual physical arguments to
 * the {@code @ParameterizedTest} method. This behavior can be seen in the table
 * below for the {@code static Stream<Object[]> factory()} method: the
 * {@code @ParameterizedTest} method accepts individual {@code String} and {@code int}
 * arguments rather than an {@code Object[]} array.
 *
 * <h3>Examples</h3>
 *
